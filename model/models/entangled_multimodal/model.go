...
// PostTokenize arranges entangled multimodal inputs for the forward pass
// The input patches are arranged as follows:
...
func init() {
	model.Register("entangled_multimodal", New)
}
